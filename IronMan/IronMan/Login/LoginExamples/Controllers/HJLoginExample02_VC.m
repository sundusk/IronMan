...
@interface HJLoginExample02_VC ()<UITextFieldDelegate>
...
@implementation HJLoginExample02_VC
...
- (void)setupUI{
    ...
    /** 设置背景 */
    self.bgImageView.animationImages = [NSArray hj_imagesWithLocalGif:@"login_bg_gif_01" expectSize:self.view.bounds.size];
